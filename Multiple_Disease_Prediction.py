...
def main():
    ...
    with st.sidebar:
        selected = option_menu('Multiple Disease Prediction System using ML',
                            ...
                            icons = ['house', 'capsule','activity','person','virus'],
                            default_index = 0)
    ...
    if selected == 'Home':
        ...
        # Home content with a custom background
        st.markdown('<div class="main">', unsafe_allow_html=True)
        
        # Title of the page
        st.markdown('<div class="title">Welcome to the Disease Prediction System</div>', unsafe_allow_html=True)

        # Subheader for clarity
        st.markdown('<div class="subheader">Your AI-Powered Healthcare Assistant</div>', unsafe_allow_html=True)

        # Short description
        st.markdown('<div class="content">This application uses machine learning models to predict the likelihood of various diseases:</div>', unsafe_allow_html=True)
        ...
        st.markdown("""
        <div class="content">
        Use the sidebar to navigate through the disease prediction models. Simply input your data, and let the AI predict your risk.
        </div>
        """, unsafe_allow_html=True)

        # Footer with a thank you note
        st.markdown('<div class="footer">Built with ❤️ by THANIGAIVELAN P</div>', unsafe_allow_html=True)
